...
public class JoyeCrawler extends MyCrawler{
    @Override
        ...
        if(getMyId()== AllDomainsDelegate.getInstance().getCrawlerTotal()){
            ...
            try {
                ObjectDomainWriteExcel.WriteDomainArchive(
                        ...
                        AllDomainsDelegate.getInstance().getListDomains(),AllDomainsDelegate.getInstance().getListDatas(),"/Users/joye/Search/crawler/joye",
                        "joye-"+getTime()+"对象站");
            } catch (IOException e) {
                e.printStackTrace();
            }
