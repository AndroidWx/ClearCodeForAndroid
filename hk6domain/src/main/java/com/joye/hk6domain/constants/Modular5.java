...
public enum Modular5 implements INumbers,IProbability{
    M0 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular5.M0;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_5,N_10,N_15,N_20,N_25,N_30,N_35,N_40,N_45  };
        }
    },M1 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular5.M1;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_1,N_6,N_11,N_16,N_21,N_26,N_31,N_36,N_41,N_46  };
        }
    },M2 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular5.M2;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_2,N_7,N_12,N_17,N_22,N_27,N_32,N_37,N_42,N_47 };
        }
    },M3 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular5.M3;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_3,N_8,N_13,N_18,N_23,N_28,N_33,N_38,N_43,N_48  };
        }
    },M4 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular5.M4;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_4,N_9,N_14,N_19,N_24,N_29,N_34,N_39,N_44,N_49  };
        }
    };
}
