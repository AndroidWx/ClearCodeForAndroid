...
public enum MantissaSize implements INumbers,IProbability {
    MantissaSmall {
        @Override
        public double getTheoryProbability() {
            return Probalility.MantissaSize.Small;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_1,N_2,N_3,N_4,N_10,N_11,N_12,N_13,N_14,N_20,N_21,N_22,N_23,N_24,N_30,N_31,N_32,N_33,N_34,N_40,N_41,N_42,N_43,N_44 };
        }
    },
    MantissaBig{
        @Override
        public double getTheoryProbability() {
            return Probalility.MantissaSize.Big;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_5,N_6,N_7,N_8,N_9,N_15,N_16,N_17,N_18,N_19,N_25,N_26,N_27,N_28,N_29,N_35,N_36,N_37,N_38,N_39,N_45,N_46,N_47,N_48,N_49 };
        }
    };
