...
public enum Region implements INumbers,IProbability{
    One {
        @Override
        public int[] getNumbers() {
            return new int[]{N_1,N_2,N_3,N_4,N_5,N_6,N_7};
        }
    },
    Two {
        @Override
        public int[] getNumbers() {
            return new int[]{N_8,N_9,N_10,N_11,N_12,N_13,N_14};
        }
    },
    Three {
        @Override
        public int[] getNumbers() {
            return new int[]{N_15,N_16,N_17,N_18,N_19,N_20,N_21};
        }
    },
    Four {
        @Override
        public int[] getNumbers() {
            return new int[]{N_22,N_23,N_24,N_25,N_26,N_27,N_28};
        }
    },
    Five {
        @Override
        public int[] getNumbers() {
            return new int[]{N_29,N_30,N_31,N_32,N_33,N_34,N_35};
        }
    },
    Six {
        @Override
        public int[] getNumbers() {
            return new int[]{N_36,N_37,N_38,N_39,N_40,N_41,N_42};
        }
    },
    Seven {
        @Override
        public int[] getNumbers() {
            return new int[]{N_43,N_44,N_45,N_46,N_47,N_48,N_49};
        }
    };
    ...
    public double getTheoryProbability() {
        return Probalility.Region.Default;
    }
}
