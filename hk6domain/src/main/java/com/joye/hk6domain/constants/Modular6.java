...
public enum Modular6 implements INumbers,IProbability{
    M0 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M0;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_6,N_12,N_18,N_24,N_30,N_36,N_42,N_48 };
        }
    },M1 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M1;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_1,N_7,N_13,N_19,N_25,N_31,N_37,N_43,N_49  };
        }
    },M2 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M2;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_2,N_8,N_14,N_20,N_26,N_32,N_38,N_44 };
        }
    },M3 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M3;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_3,N_9,N_15,N_21,N_27,N_33,N_39,N_45  };
        }
    },M4 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M4;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_4,N_10,N_16,N_22,N_28,N_34,N_40,N_46  };
        }
    },M5 {
        @Override
        public double getTheoryProbability() {
            return Probalility.Modular6.M5;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_5,N_11,N_17,N_23,N_29,N_35,N_41,N_47  };
        }
    };
}
