...
public enum  SizeTwos implements IProbability,INumbers{
    SmallOdd {
        @Override
        public double getTheoryProbability() {
            return Probalility.SizeTwos.SmallOdd;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_1,N_3,N_5,N_7,N_9,N_11,N_13,N_15,N_17,N_19,N_21,N_23};
        }
    },
    SmallEven {
        @Override
        public double getTheoryProbability() {
            return Probalility.SizeTwos.SmallEven;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_2,N_4,N_6,N_8,N_10,N_12,N_14,N_16,N_18,N_20,N_22,N_24 };
        }
    },
    BigOdd {
        @Override
        public double getTheoryProbability() {
            return Probalility.SizeTwos.BigOdd;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_25,N_27,N_29,N_31,N_33,N_35,N_37,N_39,N_41,N_43,N_45,N_47,N_49 };
        }
    },
    BigEven {
        @Override
        public double getTheoryProbability() {
            return Probalility.SizeTwos.BigEven;
        }

        @Override
        public int[] getNumbers() {
            return new int[]{N_26,N_28,N_30,N_32,N_34,N_36,N_38,N_40,N_42,N_44,N_46,N_48 };
        }
    };
    ;
}
