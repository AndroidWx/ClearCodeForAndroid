 ...
 * remark:合数大小
 */
public class CompositeSizeAdapter extends UpdateItemRecyclerViewAdapter<CompositeSizeVo> {


    public CompositeSizeAdapter(Context context) {
        super(context);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SizeItemViewHolder(LayoutInflater.from(context).inflate(R.layout.item_compositesize, parent, false));
    }
    ...
    @Override
    public void updateItems(List<CompositeSizeVo> source, boolean animated) {
        datas.clear();
        datas.addAll(source);
    ...
    public static class SizeItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setViewValue(CompositeSizeVo vo) {
