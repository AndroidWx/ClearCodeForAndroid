...
public class RippleImageButton extends ImageButton {
    ...
    public RippleImageButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_mRippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleView_mAlphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleView_mHover, mHover);
        a.recycle();
    }
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(RippleImageButton.this, 1);
                    mIsAnimating = false;
                }
