 ...
 * 
 */
public class BorderImageButton extends ImageButton implements IBadgeView, IBorderView, IHintView {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		for(int i=0;i<n;i++){
			...
			if (attr == R.styleable.Hint_hintPosition) {
				...
				setHintColor(attributes.getColor(attr, android.R.color.black));
