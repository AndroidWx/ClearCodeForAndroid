 ...
 * 
 */
public class BorderPercentRelativeLayout extends PercentRelativeLayout implements IBadgeView,
		IBorderView {
	...
	public BorderPercentRelativeLayout(Context context, AttributeSet attrs,
									   int defStyle) {
		super(context, attrs);
	...
	public BorderPercentRelativeLayout(Context context) {
		this(context, null);
	}
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		for (int i = 0; i < n; i++) {
			...
			if (attr == R.styleable.BorderableViews_borders) {
				...
				setBorders(borders);
			} else if (attr == R.styleable.BorderableViews_borderWidth__) {
				setBorderWidth(attributes.getDimensionPixelSize(attr, 0));
