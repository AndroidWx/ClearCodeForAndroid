...
public class WheelView extends View {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		for (int i = 0; i < n; i++) {
			...
			if (attr == R.styleable.Wheelview_background_wheel) {
				setWheelBackground(attributes.getResourceId(attr, 0));
			} else if (attr == R.styleable.Wheelview_background_value) {
				setWheelForeground(attributes.getResourceId(attr, 0));
			}
		}
		attributes.recycle();
	}
	...
	public View getCurrentView() {
		if (itemsLayout == null)
			return null;
		int index = currentItem - firstItem;
		if (index >= itemsLayout.getChildCount())
			return null;
	...
	private void initResourcesIfNecessary() {
		if (wheelForeground > 0 && centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					wheelForeground);
		}
	...
	/**
	 * Calculates control width and creates text com.joyepay.layouts
	 * 
	 * @param widthSize
	...
	/**
	 * Sets com.joyepay.layouts width and height
	 * 
	 * @param width
	 *            the layout width
	 * @param height
	...
	/**
	 * Creates item com.joyepay.layouts if necessary
	 */
